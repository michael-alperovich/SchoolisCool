...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializePrompts() {
	  ...
	  prompts.add(new Prompt("You walk into your Math class to find you are taking a pop quiz you haven't studied for. ", "OK", "OK", 5, 5, -5, -5, 0, 0, -10, -10, 8, 15, 0, 4));
  	  prompts.add(new Prompt("Spring Season is starting! Do you sign up for a sport?", "YES", "NO", 10, -5, 10, -5, 10, -5, -5, 15, 0, 24, 0, 6));
  	  prompts.add(new Prompt("Your crush tells you that they really like you. Do you ask them out for a date?", "YES", "NO", 15, 0, 10, -5, 5, -5, -10, 15, 8, 24, 0, 6));
  	  ...
  	  prompts.add(new Prompt("There's a scholarship available for college. Do you try to get it?", "YES", "NO", 15, -5, -15, 5, -5, 5, -5, 5, 3, 8, 0, 6));
	  prompts.add(new Prompt("Your bus is late. Yeah nothing you can do about it...", "OK", "OK", 10, 10, 0, 0, 0, 0, -5, -5, 8, 9, 0, 4));
	  prompts.add(new Prompt("A random dog ran up to you and ate your homework. Your teacher doesn't believe you", "OK", "OK", 10, 10, 0, 0, 0, 0, -5, -5, 8, 9, 0, 4));  	  
  	  prompts.add(new Prompt("There's a job opening in your area and you fit the criteria that would be needed to fill it. Do you apply for the job?", "YES", "NO", 15, -5, -10, 10, -10, 10, 15, -5, 3, 8, 0, 6));
  	  prompts.add(new Prompt("Do you sign up for an educational summer program?","YES", "SOUNDS LAME", 5, -5, -5, -5, -5, 15, 15, -5, 8, 24, 0, 4));
  	  prompts.add(new Prompt("Do you join the school's Science Team?", "YES", "NO", 15, -5, -5, 0, -5, 0, 5, 0, 8, 24, 0, 4));
  	  prompts.add(new Prompt("Do you join the school's Debate Team?", "YES", "NO", 15, -5, -5, 0, -5, 0, 5, 0, 8, 24, 0, 4));
	  ...
	  prompts.add(new Prompt("You lose your phone", "OK", "OK", 20, 20, -5, -5, -10, -10, -5, -5, 6, 24, 0, 6));
	  prompts.add(new Prompt("Fire drill during your studyblock while you were finishing a last minute essay", "OK", "OK", 10, 10, -5, -5, 0, 0, -5, -5, 8, 15, 0, 4));
